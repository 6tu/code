...
<div align="center">
	...
	<tr bgcolor="888888">
		<td title='尚白　http://shangbai.info—————————+————尚白 :)'>
			<a href="http://shangbai.info">>>　　<font color="ffffff" face='Tahoma'>站长 WEB管理</font>　　<<</a>
		</td>
		<td width="80" align="center" title='文件目录列表及管理'>
			<a href='?'>文件管理</a>
		</td>
		<td width="80" align="center" title='生成大量的连续代码'>
			<a href='?m=code'>代码生成</a>
		</td>
		<td width="80" align="center" title='生成MD5加密后的字符串'>
			<a href='?m=md5'>MD5加密</a>
		</td>
		<td width="80" align="center" title='Unix时间换算成通用时间'>
			<a href='?m=unixdate'>UNIX时间</a>
		</td>
	</tr>
	</table>
	...
	<tr bgcolor="666666">
		<td>
			管理员操作：['<a href='?login=1'><u>登陆</u></a>|<a href='?login=3'><u>退出</u></a>']<br>
			当前打开目录：{$dir}
		</td>
		<td>
			<font size="3" color="ffffff"><b>当前操作：{title}</b></font>
		</td>
	</tr>
	</table>
EOF;
